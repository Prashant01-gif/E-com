...
const Cartcart = ({ item, setCart }) => {
  return (
    <div className="flex justify-center px-4 sm:px-6 lg:px-8 mb-10 mt-5">
      <div className="border border-gray-200 bg-white w-full max-w-4xl rounded-lg shadow-lg hover:shadow-2xl transition flex flex-col sm:flex-row">
        {/* Image */}
          ...
          <div className="flex justify-between items-start w-full mb-2">
            ...
            <div className="text-red-800 text-2xl cursor-pointer">
              <MdOutlineRemoveShoppingCart
                onClick={() => RemoveCart(item, setCart)}
              />
            </div>
          </div>
